...
import 'package:jolly_podcast_test/components/colored_back_icon.dart';
...
class Custom_App_Bar_Nav_V3 extends StatefulWidget {
  ...
  final bool imageIsTitle;
  final bool imageIsPng;
  ...
  const Custom_App_Bar_Nav_V3(
      ...
      this.imageIsTitle = false,
      this.imageIsPng = true,
      })
      : super(key: key);
