...
import 'package:jolly_podcast_test/networks/formatted_response.dart';
import 'package:jolly_podcast_test/networks/logger.dart';
  ...
  Future<FormattedResponse> makeRequest(Future<Response> future,
    ...
    if (response?.data != null && response?.data.isNotEmpty) {
      ...
      try {
        ...
        return FormattedResponse(data: null, success: false, responseCodeError: "Decryption Failed");
      }
    }
    ...
    final Map<String, dynamic> header = {
      'content-type': formdata
          ...
          : formEncoded
              ...
              : 'application/json',
      'Accept': '*/*',
      'Authorization': "Bearer ${InternalStorageDB.getUserDetails()!.token}",
      'x-clientid': "jollypodcastmobile",
      'x-channel': "mobile",
